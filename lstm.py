...
class LSTMModel():
    ...
    def _build_model(self):
        ...
        model = PointTransformer(n_embed = 16,n_layers=2,num_tokens=21,period=7,n_head=8,dropout_p=0.2,mlp_dim=16)
    ...
    def fit(self, df, lr=0.001, epochs=100):
        ...
        writer = SummaryWriter('./runs/train_PointTransformer_{}_{}_h{}_nl{}_lr{}_dp{}_ep{}'.format(self.input_len,
        ...
        torch.save(save_check, './check/PointTransformernet_{}_{}_h{}_lv{}_lr{}_dp{}_ep{}.pkl'.format(self.input_len,
                                                                                          self.output_len,
                                                                                          self.hid_size,
                                                                                          self.num_layers, lr,
...
if __name__ == '__main__':
    ...
    # train
    model.fit(df, lr=0.001, epochs=3)

    # test
    # model.load('check/PointTransformer_21_7_h128_lv2_lr0.001_dp0.1_ep15.pkl')
    # result_df,probs = predict_all(model)
    # print(probs)
    # result_df.to_csv('./result/result_PointTransformer_new.csv',index=False)